...
static int test_one_input_decodepstt_rpc(const uint8_t* data, size_t size)
{
...
{
    return test_one_input_decodepstt_rpc(data, size);
}
...
{
    test_one_input_decodepstt_rpc(data, size);
    return 0;
}
